...
We keep the stationary OU standard deviation fixed:
    ...
    bar_sigma = sigma / sqrt(2 theta),   bar_sigma / m = 0.5,
...
Run:
    python tests/test_ougf_theta_rescaled_gap.py
...
def main():
    ...
    output1 = Path(__file__).with_name("ougf_theta_rescaled_growth.png")
    ...
    output2 = Path(__file__).with_name("ougf_theta_rescaled_gap.png")
